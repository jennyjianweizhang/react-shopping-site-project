...
import { setUser} from '../store/proudctDataSlice';
    ...
    const handleClick = async (e) => {
        ...
        signInWithEmailAndPassword(auth, email, password)
            .then(async (userCredential) => {
                ...
                // Query Firestore for additional user data
                ...
                if (!querySnapshot.empty) {
                    ...
                    userProfile = {
                        ...
                        creationDate: creationTime ? creationTime.toLocaleDateString() : 'Unknown', 
                        // other data you want to store
                    };
                } else {
                    userProfile = {
                        name: 'User', // Default name or handle no name scenario
                        email: user.email
                    };
                }
  ...
  return (
        ...
        <div className="col-md-4 col-lg-6 ml-auto">
                <form onSubmit={handleClick}>
                    <div className="row">
                        ...
                        <div className="form-group col-lg-12 mx-auto mb-0 signinBox">
                            <button type="submit" href="#" className="btn btn-primary btn-block py-2 signin">
    ...
    <div className="container">
        <div className="text-center w-100 bottomBox">
            <p className="text-muted font-weight-bold text">Don't have an account? </p>
            <button className="button button-small button-border button-border-gray" type="button" onClick={navigateToSignUp}>Sign Up</button>
        </div>
    </div>
